 ...
 *           le type du XTO
 * @param <TypeEntity>
 *           le Entity correspondant au XTO
 */
public abstract class EntityGwtRemoteServiceImpl<TypeId, TypeXto extends Xto_Itf<TypeId>, TypeEntity extends Entity_Itf<TypeId>>
         extends SpiRemoteServiceImpl implements GwtRemoteService<TypeId, TypeXto>
{
   ...
   {
      return getMapper().convertEntityItfToXto(getService().save(getMapper().convertXtoToEntity(p_xto)));
   }
   ...
   /**
    * @return le service réel proposant les opérations sur le Entity
    */
