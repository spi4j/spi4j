 ...
 * @author MINARM
 */
public abstract class SpiViewDialog<TypePresenter extends Presenter_Abs<? extends View_Itf, ?>> extends DialogBox
         implements View_Itf
{
    ...
    */
   public SpiViewDialog (final TypePresenter p_presenter)
   {
      super();
      // if (p_presenter == null)
      // {
