...
{
   // Les instances maximumValue et minimumValue sont partagées pour tous les champs de date
    ...
    * @param newEditable
    *           true si le composant doit être modifiable, false sinon
    */
   ...
   /**
    * Validation interne d'une date selon minimumValue et maximumValue ou si date avant 01/01/0100. <br/>
    * Si elle n'est pas dans la période, renvoie une date replacée dans le siècle <br/>
    * (même date avec l'année entre -80 ans et +20 ans par rapport à l'année courante). <br/>
    * Si cela ne suffit pas (min. 1900 ou max. 2100 ont été modifiés), renvoie min. ou max.
    * @return Date
    * @param p_date
    *           date
    */
   ...
   // // (en comparant à l'année courante + 20 ans, cela ajoute le siècle courant ou celui d'avant)
   // try
   // {
