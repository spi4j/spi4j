...
import fr.spi4j.persistence.dao.jdbc.JdbcOptimistLocked_Itf;
import fr.spi4j.persistence.dao.jdbc.JdbcVersion;

/**
 * Entité du type Personne.
 * @author MINARM
 */
public class MyVersionnedPersonneEntity implements MyPersonneEntity_Itf, JdbcOptimistLocked_Itf
{
   // CONSTANTES
