 ...
 * @author MINARM
 */
public enum MyGradeColumns_Enum implements ColumnsNames_Itf
{
   /** Grade_id. */
    ...
    */
   private MyGradeColumns_Enum (final String p_logicalColumnName, final String p_physicalColumnName,
