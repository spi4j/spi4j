...
/**
 * L'énumération définissant les informations de chaque colonne pour le type Personne.
 * @author MINARM
 */
public enum MyPersonneColumns_Enum implements ColumnsNames_Itf
{
   /** Personne_id. */
   Personne_id("Personne_id", "PERSONNE_ID", Long.class, true, -1, true),
   /** nom. */
   nom("nom", "NOM", String.class, true, -1, false),
   /** prenom. */
   prenom("prenom", "PRENOM", String.class, false, -1, false),
   /** civil. */
   civil("civil", "CIVIL", Boolean.class, true, -1, false),
   /** dateNaissance. */
   dateNaissance("dateNaissance", "DATE_NAISSANCE", Date.class, false, -1, false),
   /** salaire. */
   salaire("salaire", "SALAIRE", Double.class, false, -1, false),
   /** version. */
   version("version", "VERSION", Date.class, true, -1, false),
   /** grade_id. */
   grade_id("grade_id", "GRADE_ID", Long.class, false, -1, false);
    ...
    */
   private MyPersonneColumns_Enum (final String p_logicalColumnName, final String p_physicalColumnName,
