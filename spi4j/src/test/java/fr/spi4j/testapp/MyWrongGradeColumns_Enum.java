...
/**
 * L'énumération définissant les informations de chaque colonne pour le type Grade.
 * @author MINARM
 */
public enum MyWrongGradeColumns_Enum implements ColumnsNames_Itf
{
   /** Grade_id. */
   Grade_id("Grade_id", "GRADE_ID", Long.class, true, -1, true),
   /** libelle. */
   libelle("libelle", "LIBELLE", String.class, true, -1, false),
   /** trigramme. */
   trigramme("trigramme", "TRIGRAMME", String.class, true, 3, false),
   /** trigramme. */
   colonne_inconnue("colonne_inconnue", "NO_COL", String.class, true, -1, false),
   /** libelle abrégé. */
   libelleAbrege("libelleAbrege", "LIBELLE_ABREGE", String.class, true, -1, false);
    ...
    */
   private MyWrongGradeColumns_Enum (final String p_logicalColumnName, final String p_physicalColumnName,
