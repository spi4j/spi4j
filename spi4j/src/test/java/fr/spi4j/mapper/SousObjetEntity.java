 ...
 * @author MINARM
 */
public class SousObjetEntity implements Entity_Itf<Long>
{
    ...
    * @return _parent
    */
   public SimpleEntity get_parent ()
   {
      return _parent;
   }
    ...
    *           nouveau _parent
    */
   public void set_parent (final SimpleEntity p_parent)
   {
      _parent = p_parent;
   }
