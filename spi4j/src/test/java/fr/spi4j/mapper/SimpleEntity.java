 ...
 * @author MINARM
 */
public class SimpleEntity implements Entity_Itf<Long>
{
   /**
    * SerialUid.
    */
   ...
   private SousObjetEntity _sousObjet;

   private List<SousObjetEntity> _tab_sousObjets;

   private Map<Integer, SousObjetEntity> _map_intSousObjets;

   private Map<SousObjetEntity, Long> _map_sousObjetsLong;
    ...
    * @return _sousObjet
    */
   public SousObjetEntity get_sousObjet ()
   {
      return _sousObjet;
   }
    ...
    *           nouveau _sousObjet
    */
   public void set_sousObjet (final SousObjetEntity p_sousObjet)
   {
    ...
    */
   public List<SousObjetEntity> get_tab_sousObjets ()
   {
      return _tab_sousObjets;
   }
    ...
    */
   public void set_tab_sousObjets (final List<SousObjetEntity> p_tab_sousObjets)
   {
    ...
    */
   public Map<Integer, SousObjetEntity> get_map_intSousObjets ()
   {
      return _map_intSousObjets;
   }
    ...
    */
   public void set_map_intSousObjets (final Map<Integer, SousObjetEntity> p_map_intSousObjets)
   {
    ...
    */
   public Map<SousObjetEntity, Long> get_map_sousObjetsLong ()
   {
      return _map_sousObjetsLong;
   }
    ...
    */
   public void set_map_sousObjetsLong (final Map<SousObjetEntity, Long> p_map_sousObjetsLong)
   {
