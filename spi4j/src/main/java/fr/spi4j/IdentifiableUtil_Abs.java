...
public abstract class IdentifiableUtil_Abs
{
   ...
   /**
    * Recherche un identifiabel dans une collection (une liste par exemple) selon son identifiant.
    * @param <T>
    *           Type du Identifiable_Itf
    * @param p_collection
    *           Collection de Identifiable_Itf
    * @param p_id
    *           Identifiant
   ...
   /**
    * Recherche une liste de Identifiables dans une collection (une liste par exemple) selon la valeur d'un attribut (clé fonctionnelle par exemple).
    * @param <T>
    *           Type du Identifiable
    * @param p_collection
    *           Collection de Identifiable
    * @param p_attribute
    *           Attribut (obligatoire)
    * @param p_value
    *           Valeur de l'attribut (peut être null)
   ...
   /**
    * Recherche un et un seul Identifiable dans une collection (une liste par exemple) selon la valeur d'un attribut (clé fonctionnelle par exemple)
    * @param <T>
    *           Type du Identifiable
    * @param p_collection
    *           Collection de Identifiable
            ...
            final AttributesNames_Itf p_attribute, final Object p_value)
   {
      ...
      // un et un seul Identifiable doit correspondre à la valeur de l'attribut recherchée
      if (v_list.size() > 1)
      {
   ...
   /**
    * Recherche un Identifiable dans une collection (une liste par exemple) selon l'identifiant du Identifiable en paramètre.
    * @param <T>
    *           Type du Identifiable
    * @param p_collection
    *           Collection de Identifiable
    * @param p_identifiable
    *           Identifiable contenant un identiant
   ...
   /**
    * Recherche les Identifiables dans une collection (une liste par exemple) selon l'identifiant du Identifiable en paramètre.
    * @param <T>
    *           Type du Identifiable
    * @param <I>
            ...
            final Collection<T> p_collection, final Collection<I> p_listIds)
   {
      ...
      if (!p_listIds.isEmpty())
      {
         ...
         for (final I v_id : p_listIds)
         {
            ...
            if (v_identifiable == null)
            {
               throw new Spi4jRuntimeException("Aucun enregistrement trouvé dans la liste pour l'id '" + v_id + '\'',
                        "Vérifier la cohérence des données");
            }
   ...
   /**
    * A partir d'une collection de Identifiables, construit une liste avec les identifiants des Identifiables.<br/>
    * @param <T>
    *           Type du Identifiable
    * @param <I>
    *           Type de l'identifiant
   ...
   /**
    * A partir d'une collection de Identifiables, construit une map non ordonnée avec les identifiants comme clés et les Identifiables comme valeur.<br/>
    * @param <T>
    *           Type du Identifiable
    * @param <I>
    *           Type de l'identifiant
   ...
   /**
    * A partir d'une collection de Identifiables, construit une map ordonnée avec les identifiants comme clés et les Identifiables comme valeur.<br/>
   ...
   protected static <T extends Identifiable_Itf<I>, I> Map<I, T> createSortedMapByIdAbs (
            final Collection<T> p_collection)
   {
      // map ordonnée pour conserver l'ordre s'il y en avait un dans la collection en paramètre (si c'est une liste par exemple)
   ...
   /**
    * Tri une liste selon un attribut en paramètre. La liste en paramètre est directement modifiée pour être triée.
    * @param <T>
    *           Type du Identifiable
    * @param p_list
    *           Liste de Identifiables
    * @param p_attribute
    *           Attribut de tri
    */
            ...
            final AttributesNames_Itf p_attribute, final boolean p_ascending, final boolean p_ignoreCase)
   {
      Comparator<T> v_comparator = new Comparator<>()
      {
         ...
         public int compare (final T p_identifiable1, final T p_identifiable2)
         {
            ...
            {
               // on teste String avant Comparable pour pouvoir utiliser collator ou compareToIgnoreCase
               // si on ignore la casse, alors on ignore aussi les accents donc on utilise un collator au lieu de String.compareToIgnoreCase
            ...
            final AttributesNames_Itf p_attribute)
   {
      ...
      if (v_method == null)
      {
         throw new Spi4jRuntimeException("Getter pour l'attribut " + p_attribute + " non trouvé dans "
                  + p_attribute.getClass(), "Vérifier que le type de l'attribut correspond au type du Identifiable");
      }
      try
      {
            ...
            final Object p_value)
   {
      ...
      if (v_method == null)
      {
         throw new Spi4jRuntimeException("Setter pour l'attribut " + p_attribute + " non trouvé dans "
                  + p_attribute.getClass(), "Vérifier que le type de l'attribut correspond au type du Identifiable");
      }
      try
      {
   ...
   /**
    * Clone/Copie complète d'un Identifiable, y compris des références telles que des listes.
    * @param <T>
    *           Type du Identifiable
    * @param p_identifiable
    *           Identifiable
   ...
   /**
    * Clone/Copie d'un Identifiable, sans cloner les références et même si le Identifiable n'implémente pas Cloneable.
    * @param <T>
    *           Type du Identifiable
    * @param p_identifiable
    *           Identifiable
    ...
    * @param p_nomChamp
    *           le nom fonctionnel du champ
    * @param p_valeur
    *           la valeur du champ
    * @param p_champsInvalides
    *           la liste des champs déjà invalides ou null si aucun champ invalide
    ...
    *           la valeur du champ
    * @param p_maxSize
    *           la taille maximale du champ (définie dans AttributesEnum ou ColumnsEnum)
    * @param p_champsInvalides
    *           la liste des champs déjà invalides ou null si aucun champ invalide
    * @return la liste des champs invalides + ce dernier si celui-ci est null
    */
