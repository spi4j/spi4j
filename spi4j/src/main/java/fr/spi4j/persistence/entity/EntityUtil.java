...
// extends IdentifiableUtil_Abs
{
   ...
   /**
    * Recherche un Entity dans une collection (une liste par exemple) selon son identifiant.
    * @param <T>
    *           Type du Entity
    * @param p_collection
    ...
    */
   public static <T extends Entity_Itf<?>> T findInCollectionById (final Collection<T> p_collection, final Object p_id)
   {
      if (p_id == null)
      {
   ...
   /**
    * Recherche une liste de Entitys dans une collection (une liste par exemple) selon la valeur d'un attribut (clé fonctionnelle par exemple).
    * @param <T>
    *           Type du Entity
    * @param p_collection
    *           Collection de Entity
   ...
   /**
    * Recherche un et un seul Entity dans une collection (une liste par exemple) selon la valeur d'un attribut (clé fonctionnelle par exemple)
    * @param <T>
    *           Type du Entity
    * @param p_collection
    *           Collection de Entity
   ...
   /**
    * Recherche un Entity dans une collection (une liste par exemple) selon l'identifiant du Identifiable en paramètre.
    * @param <T>
    *           Type du Entity
    * @param p_collection
    *           Collection de Entity
    * @param p_entity
    *           Entity contenant un identiant
   ...
   /**
    * Recherche les Entitys dans une collection (une liste par exemple) selon l'identifiant du Entity en paramètre.
    * @param <T>
    *           Type du Entity
    * @param <I>
   ...
   /**
    * A partir d'une collection de Entitys, construit une liste avec les identifiants des Entitys.<br/>
    * @param <T>
    *           Type du Entity
    * @param <I>
    *           Type de l'identifiant
   ...
   /**
    * A partir d'une collection de Entitys, construit une map non ordonnée avec les identifiants comme clés et les Entitys comme valeur.<br/>
    * @param <T>
    *           Type du Entity
    * @param <I>
    *           Type de l'identifiant
   ...
   /**
    * A partir d'une collection de Entitys, construit une map ordonnée avec les identifiants comme clés et les Entitys comme valeur.<br/>
   ...
   {
      final Method v_method = EntityAttributeHelper.getInstance().getGetterMethodForColumn(p_entity,
               p_column);
   ...
   /**
    * Clone/Copie complète d'un Entity, y compris des références telles que des listes.
    * @param <T>
    *           Type du Entity
    * @param p_entity
    *           Entity
   ...
   /**
    * Clone/Copie d'un Entity, sans cloner les références et même si le Entity n'implémente pas Cloneable.
    * @param <T>
    *           Type du Entity
    * @param p_entity
    *           Entity
