 ...
 * @author MINARM
 */
public class MysqlNonXAResourceManager extends NonXAJdbcResourceManager_Abs
{
   @Override
   protected CommonDataSource createDataSource (final ResourcePhysical_Abs p_resourcePhysical) throws SQLException
   {
      ...
      return (DataSource) createDataSource("com.mysql.jdbc.jdbc2.optional.MysqlDataSource", v_props);
   }
}
