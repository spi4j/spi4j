...
/**
 * Intercepteur pour EJB 3 qui démarre une transaction Spi4J avant l'appel de la
 * méthode puis qui commit la transaction après l'appel de la méthode ou qui
...
public final class TransactionInterceptor implements Serializable {
	...
	/**
	 * Initialise le userPersistence pour pouvoir utiliser cet interceptor : au
	 * démarrage de l'application, appele :
	 * "TransactionInterceptor.initUserPersistence(XxParamPersistence.getUserPersistence());"
	 *
