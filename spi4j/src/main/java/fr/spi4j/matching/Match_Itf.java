...
abstract public interface Match_Itf<TypeId, TypeDto extends Dto_Itf<TypeId>, TypeEntity extends Entity_Itf<TypeId>, Columns_Enum extends ColumnsNames_Itf>
{
    ...
    * 
    * <pre>
    * final List&lt;PersonneDto&gt; v_personnes = personneMatch.findByColumn(PersonneEntity_Itf.PersonneColumns_Enum.nom, &quot;DUPONT&quot;);
    * </pre>
    * @param p_column
    *           (In)(*) Le paramètre 'column' (obligatoire).
    * @param p_value
    *           (In) La valeur recherchée dans p_column, valeur qui peut être un DTO ou une Entity ou même null
    * @return La liste des tuples.
    */
