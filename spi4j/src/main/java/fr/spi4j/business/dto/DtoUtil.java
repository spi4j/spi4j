...
public final class DtoUtil
{
   ...
   /**
    * Recherche un DTO dans une collection (une liste par exemple) selon son identifiant.
    * @param <T>
    *           Type du DTO
    * @param p_collection
    *           Collection de DTO
   ...
   /**
    * Recherche une liste de DTOs dans une collection (une liste par exemple) selon la valeur d'un attribut (clé fonctionnelle par exemple).
    * @param <T>
    *           Type du DTO
    * @param p_collection
    *           Collection de DTO
   ...
   /**
    * Recherche un et un seul DTO dans une collection (une liste par exemple) selon la valeur d'un attribut (clé fonctionnelle par exemple)
    * @param <T>
    *           Type du DTO
    * @param p_collection
    *           Collection de DTO
   ...
   /**
    * Recherche un DTO dans une collection (une liste par exemple) selon l'identifiant du DTO en paramètre.
    * @param <T>
    *           Type du DTO
    * @param p_collection
    *           Collection de DTO
    * @param p_dto
    *           DTO contenant un identiant
   ...
   /**
    * Recherche les DTOs dans une collection (une liste par exemple) selon l'identifiant du DTO en paramètre.
    * @param <T>
    *           Type du DTO
    * @param <I>
    ...
    * @return Les DTOs trouvés (ne peut pas être null)
    */
   public static <T extends Identifiable_Itf<I>, I> List<T> findInCollectionByListIds (
   ...
   /**
    * A partir d'une collection de DTOs, construit une liste avec les identifiants des DTOs.<br/>
    * @param <T>
    *           Type du DTO
    * @param <I>
    *           Type de l'identifiant
   ...
   /**
    * A partir d'une collection de DTOs, construit une map non ordonnée avec les identifiants comme clés et les DTOs comme valeur.<br/>
    * @param <T>
    *           Type du DTO
    * @param <I>
    *           Type de l'identifiant
   ...
   /**
    * A partir d'une collection de DTOs, construit une map ordonnée avec les identifiants comme clés et les DTOs comme valeur.<br/>
   ...
   /**
    * Clone/Copie complète d'un DTO, y compris des références telles que des listes.
    * @param <T>
    *           Type du DTO
    * @param p_dto
    *           DTO
   ...
   /**
    * Clone/Copie d'un DTO, sans cloner les références et même si le DTO n'implémente pas Cloneable.
    * @param <T>
    *           Type du DTO
    * @param p_dto
    *           DTO
