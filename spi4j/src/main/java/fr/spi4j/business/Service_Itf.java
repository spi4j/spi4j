 ...
 * un service).
 * <p>
 * Ces services seront accessibles de la même façon depuis un client java, avec
 * une implémentation passant par du "remoting" vers le serveur.
 *
 * @param <TypeId>  Type de clé primaire
 * @param <TypeDto> Type du DTO
 */
abstract public interface Service_Itf<TypeId, TypeDto extends Dto_Itf<TypeId>> extends ApplicationService_Itf {
	 ...
	 *
	 * @param p_dto (In/Out)(*) Le tuple à insérer est obligatoire. Si sa clé
