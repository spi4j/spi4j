...
public abstract class Service_Abs<TypeId, TypeDto extends Dto_Itf<TypeId>, Columns_Enum extends ColumnsNames_Itf>
	...
	/**
	 * @return Une instance du matching typée pour correspondre à l'instance du
	 *         service.
	 */
	...
	/**
	 * Applique une fetching strategy sur une liste de DTOs.
	 * <p>
	 ...
	 * le type de la fetching strategy correspondant au type des DTOs.
	 *
	 * @param p_fetchingStrategy Fetching Strategy à appliquer sur les DTOs
	 ...
	 *                 qui peut être un DTO ou une Entity ou même null
	 * @return La liste des tuples.
	 */
