...
abstract public class FetchingStrategy_Abs<TypeId, TypeDto extends Dto_Itf<TypeId>> implements Serializable
{
    ...
    */
   protected FetchingStrategy_Abs (final AttributesNames_Itf p_attribute, final FetchingStrategy_Abs<?, ?> p_parent)
   {
      super();
    ...
    */
   public AttributesNames_Itf getAttribute ()
   {
      return _attribute;
   }
   ...
   public String path ()
   {
      ...
      {
         v_result = _parent.path() + '.' + _attribute.getName();
      }
      return v_result;
   }
    ...
    * @return List
    */
   public List<FetchingStrategy_Abs<TypeId, ? extends Dto_Itf<TypeId>>> getChildren ()
   {
