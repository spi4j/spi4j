...
/**
 * Gestion de cache optionnelle utilisant la librarie Ehcache.
 *
...
class EhCache<K, V> implements Cache_Itf<K, V> {
	 ...
	 * Constructeur.
	 *
	 * @param p_cacheName Nom unique du cache
	 */
	EhCache(final String p_cacheName) {
		super();
		// la configuration du cache sera déduite du fichier ehcache.xml présent à côté
		// des classes
		// et selon son nom si paramétré dans ehcache.xml ou selon la configuration par
		// défaut paramétrée dans ehcache.xml
