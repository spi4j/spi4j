...
/**
 * Gestion de cache par défaut.
 * <p>
 * Les références en cache sont conservées en fonction de la place mémoire
 * disponible.
 *
...
class CacheSoft<K, V> implements Cache_Itf<K, V> {
	 ...
	 * but also the _key to make it easier to find the entry in the Map after it's
	 ...
	 * objects from the HashMap by looking them up using the SoftValue._key data
	 * member.
	 */
