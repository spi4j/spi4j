...
/**
 * Interface "Façade" des services liés à un "objet métier" (représenté par un ENTITY). <br/>
 ...
 *           Type du ENTITY
 */
abstract public interface Service_Itf<TypeId, TypeEntity extends Entity_Itf<TypeId>> extends
         ApplicationService_Itf
{
   /**
