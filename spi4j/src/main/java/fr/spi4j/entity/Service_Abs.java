 ...
 *
 * @author MINARM
 * @param <TypeId>       Type de l'identifiant de l'Entity
 * @param <TypeEntity>   Type de Entity
...
public abstract class Service_Abs<TypeId, TypeEntity extends Entity_Itf<TypeId>, Columns_Enum extends ColumnsNames_Itf>
	...
	/**
	 * Applique une fetching strategy sur une liste de Entitys.
	 * <p>
	 * Cette méthode a l'intérêt d'être simple à appeler dans l'implémentation d'un
	 * service, et comme FetchingStrategyFetcher elle vérifie à la compilation que
	 * le type de la fetching strategy correspondant au type des Entitys.
	 *
	 * @param p_fetchingStrategy Fetching Strategy à appliquer sur les Entitys
	 * @param p_listeEntity      Liste de Entitys
	 */
	...
	// *********************************************************************************************************************
	// Remarque: les services findByColumn, findByCriteria et deleteByCriteria sont
	// protected et non publics
	// car ils ne doivent pas être appelée directement depuis le client de la façade
	// de service (par exemple la partie vue),
	// et la façade de service doit définir une méthode avec un nom signifiant
	// fonctionnellement
	// dont l'implémentation appelera findByColumn, findByCriteria ou
	// deleteByCriteria en étant elle liée aux entités persistentes.
	// *********************************************************************************************************************
	 ...
	 * @param p_value  (in) La valeur recherchée dans la colonne p_column, valeur
	 *                 qui peut être une Entity ou même null
	 * @return La liste des tuples.
	 */
