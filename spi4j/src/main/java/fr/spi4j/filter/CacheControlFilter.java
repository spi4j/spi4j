...
/**
 * Implémentation de jakarta.servlet.Filter utilisée pour contrôler la mise en
 * cache dans le navigateur client.
 * <p>
 * Note : Une "limitation de la sécurité" de MSIE 5.5 (bug non présent dans
 * Firefox) n'accepte ni Cache-Control=no-cache, ni Pragma=no-cache en SSL sur
 * les téléchargements de fichiers pdf, doc, xls, xml : remplacer
 * Cache-Control=no-cache par max-age=1.
 *
 * @author MINARM
 */
