...
public interface SpiRemotingSerializer_Itf
{
   ...
   /**
    * Ecrit dans le flux de la requête http l'objet request du service demandé avec ses arguments.
    * @param p_request
    *           Objet request
    * @param p_output
    *           Flux de sortie
   ...
   /**
    * Lit en retour dans le flux de la réponse http le résultat de l'exécution du service. <br/>
    * Dans les faits, c'est cette méthode qui lance l'appel http et l'exécution du service côté serveur.
    * @param p_input
    *           Flux d'entrée
