...
public class SSOAuthenticatorMock implements SSOAuthenticator_Itf
{
   ...
   /**
    * Retourne l'instance du SSO Authenticator utilisée pour les tests. <br/>
    * Retourne l'instance réelle du SSO Authenticator si le serveur est joignable ou un SSO Authenticator mocké (bouchon) si le serveur n'est pas joignable.
    * @param p_url
