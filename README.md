...
<br />
Ces projets ont été créés avec la participation de **[Bull](http://www.bull.fr)** et sont encore en cours en mars 2015 (version courante : 1.5).
...
Si vous ne disposez pas de **Safr@n Studio**, il est également possible de créer les modèles soit en utilisant une version illimité avec des éditeurs arborescents ou bien avec une version d'essai du designer : [InstallationIdeSpi4jPacman](InstallationIdeSpi4jPacman.md).
