...
public final class SpiSwingUtilities
{
    ...
    * Cette méthode peut-être très utile pour récupérer une référence à un parent éloigné (ancêtre), en l'absence de référence directe du type attribut. <br/>
   ...
   /**
    * Méthode utilisée par SpiBasicTable et SpiComboBox pour essayer d'extraire un texte d'un composant de rendu.
   ...
   /**
    * Affiche un splash screen lors du lancement de l'application (ne pas oublier d'appeler {@link #hideSplashScreen()} à la fin de l'initialisation, juste après l'affichage du premier écran)
    * @param p_titreApp
    *           le titre de la fenêtre du splash screen
    * @param p_splash
    ...
    * @param p_runnable
    *           le code à exécuter Exemple d'appel:
    *
    *           <pre>
