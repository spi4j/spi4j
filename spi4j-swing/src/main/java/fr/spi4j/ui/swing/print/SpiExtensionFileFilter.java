 ...
 */
public class SpiExtensionFileFilter extends FileFilter
{
   private Map<String, SpiExtensionFileFilter> filters;
    ...
    * @see #addExtension
    */
   public SpiExtensionFileFilter ()
   {
      this.filters = new HashMap<String, SpiExtensionFileFilter>(0);
   }

   /**
    * Creates a file filter from the given string array and description. Example: new SpiExtensionFileFilter(String {"gif", "jpg"}, "Gif and JPG Images"); Note that the "." before the extension is not needed and will be ignored.
    * @param newFilters
    *           String[]
    ...
    * @see #addExtension
    */
   public SpiExtensionFileFilter (final String[] newFilters, final String newDescription)
   {
      this();
   ...
   /**
    * Creates a file filter that accepts files with the given extension. Example: new SpiExtensionFileFilter("jpg");
    * @param extension
    *           String
    * @see #addExtension
    */
   public SpiExtensionFileFilter (final String extension)
   {
      this(extension, null);
   }

   /**
    * Creates a file filter that accepts the given file type. Example: new SpiExtensionFileFilter("jpg", "JPEG Image Images"); Note that the "." before the extension is not needed. If provided, it will be ignored.
    * @param extension
    *           String
    * @param newDescription
    *           String
    * @see #addExtension
    */
   public SpiExtensionFileFilter (final String extension, final String newDescription)
   {
      this();
      if (extension != null)
      {
   ...
   /**
    * Adds a filetype "dot" extension to filter against. For example: the following code will create a filter that filters out all files except those that end in ".jpg" and ".tif": SpiExtensionFileFilter filter = new SpiExtensionFileFilter(); filter.addExtension("jpg"); filter.addExtension("tif"); Note that the "." before the extension is not needed and will be ignored.
    * @param extension
    *           String
    */
   public void addExtension (final String extension)
   {
      if (filters == null)
      {
         filters = new HashMap<String, SpiExtensionFileFilter>(1);
      }
