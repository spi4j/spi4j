...
/**
 * Permet de regrouper automatiquement les JRadioButtons qu'on ajoute dans ce
 * panel.
 * <p>
 * Arrow key support by Alexander Potochkin
 * (http://weblogs.java.net/blog/alexfromsun/archive/2006/11/kiss_principle.html,
 * LGPL)
 * 
...
public class SpiRadioButtonPanel extends SpiPanel {
	...
	// ce layout par défaut est une constante statique (design pattern poids-mouche
	// / fly-weight),
	...
	private class RadioButtonPanelFocusTraversalPolicy extends LayoutFocusTraversalPolicy {
		 ...
		 * 
		 * @param newAlternativeFocusMode boolean
		 */
	...
	/**
	 * Initialise la possibilité d'utiliser les flèches du clavier pour passer d'un
	 * bouton à l'autre (comme Windows).
	 */
