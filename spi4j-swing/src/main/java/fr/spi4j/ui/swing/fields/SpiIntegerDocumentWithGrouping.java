...
/**
 * Document swing alternatif à SpiIntegerDocument pour la saisie d'un nombre entier, et qui affiche et accepte en saisie des séparateurs de milliers. <br/>
 * Pour l'utiliser, appeler au démarrage de l'application :<br/>
 * System.setProperty("fr.spi4j.ui.swing.fields.SpiIntegerField.documentType", "fr.spi4j.ui.swing.fields.SpiIntegerDocumentWithGrouping");
 * @author MINARM
 */
public class SpiIntegerDocumentWithGrouping extends SpiIntegerDocument
{
            ...
            throws BadLocationException
   {
      ...
      isOK = isOK && value >= getMinimumValue() && value <= getMaximumValue() && NUMBER_PATTERN.matcher(text).matches();
