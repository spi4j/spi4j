...
/**
 * Editor de dates avec calendrier pour les cellules des JTables. <br/>
 * Attention : sur cet éditeur, mettre clickCountToStart à 1 au lieu de 2 peut entraîner des problèmes de focus.
 * @author MINARM
 */
