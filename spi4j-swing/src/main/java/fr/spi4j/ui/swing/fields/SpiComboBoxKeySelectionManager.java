...
/**
 * Ce KeySelectionManager sélectionne les éléments d'une comboBox selon une
 * chaîne de caractères au lieu d'un seul caractère.
 * <p>
 * La chaîne se constitue par les caractères se suivant à moins de 500 ms, et se
 * réinitialise au delà.
 * 
