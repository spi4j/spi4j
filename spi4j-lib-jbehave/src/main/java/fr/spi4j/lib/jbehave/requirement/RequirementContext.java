...
/**
 * Permet de suivre les méthodes portant une annotation
 * RequirementAnnotationForTest qui ont été invoquées.
 * <p>
 * Permet aussi de demander quelles méthodes ont été invoquées pour un
 * RequirementAnnotationForTest donné. Permet donc d'en déduire si un
 * RequirementAnnotationForTest a été utilisé pendant l'execution d'un
 * programme.
 * 
 * @author MINARM
 */
public class RequirementContext {
	 ...
	 * 
	 * @param p_req    l'exigence tirée
	 * @param p_method la méthode dans laquelle l'exigence est tirée
	 */
	 ...
	 * 
	 * @param p_requirement l'exigence
