...
/**
 * Enumération des types de document courants, permettant d'obtenir le mime-type
 * (ou ContentType en http).
 * 
 * @author MINARM
 */
public enum DocType {
	 ...
	 * @return Type mime.
	 *         <p>
	 *         Par exemple, pour fournir un document PDF via http, il est possible
	 *         d'indiquer son type :
	 *         <code>httpResponse.setContentType(DocType.PDF.getMimeType())</code>
	 */
