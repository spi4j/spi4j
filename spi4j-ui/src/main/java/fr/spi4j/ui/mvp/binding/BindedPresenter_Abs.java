 ...
 * Chaque instance de présenteur est lié à une et une seule instance de vue et à une et une seule instance Dto.
 * @param <TypeView>
         ...
         extends Presenter_Abs<TypeView, TypeDto>
{
   ...
   /**
    * Initialise un binding entre un attribut de DTO (p_attribute) et un champ de la vue (p_field). C'est la méthode getValue ou setValue qui sera appelée sur le champ de la vue.
    * @param p_attribute
    *           l'attribut d'un DTO
    * @param p_field
    *           le champ de la vue
   ...
   /**
    * Remplit les champs de la vue avec les données du DTO grâce aux bindings précédement initialisés.
    */
