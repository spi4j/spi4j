 ...
 * une et une seule instance Entity.
 * 
 * @param <TypeView>   le type de vue présentée
 * @param <TypeEntity> le type de Entity affiché, ou Object si aucun Entity
 * @author MINARM
 */
public abstract class BindedPresenterEntity_Abs<TypeView extends View_Itf, TypeEntity extends Entity_Itf<?>>
	 ...
	 * 
	 * @param p_parent le présenteur parent
	 * @param p_entity l'entity de ce présenteur
	 */
	...
	protected void initPresenter() {
		...
		// remplissage des champs à partir de l'entity (aucune action si l entity est
		// null)
	...
	/**
	 * Initialise un binding entre un attribut de Entity (p_attribute) et un champ
	 * de la vue (p_field). C'est la méthode getValue ou setValue qui sera appelée
	 * sur le champ de la vue.
	 * 
	 * @param p_column la colonne d'une entity
	...
	/**
	 * Remplit les champs de la vue avec les données de l'etity grâce aux bindings
	...
	/**
	 * @return La classe du Entity à partir du type générique spécifié par
	 *         l'appelant.
	 */
	...
	Class<TypeEntity> getEntityClass() {
		...
		// }
		//
		// return (Class<TypeEntity>) ((ParameterizedType) getClass().
