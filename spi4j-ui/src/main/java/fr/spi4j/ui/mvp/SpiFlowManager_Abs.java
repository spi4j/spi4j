...
public abstract class SpiFlowManager_Abs
{
   ...
   /**
    * Cette méthode effectue un traitement au démarrage du flow : appel d'une action, affichage d'un écran.
    */
   ...
   /**
    * Cette méthode effectue un traitement à l'arrêt normal du flow : récupération du flow précédent pour trouver le prochain écran à afficher. <br />
   ...
   /**
    * Cette méthode effectue un traitement à l'arrêt en erreur du flow : récupération du flow précédent pour trouver le prochain écran à afficher. <br />
    * Par défaut : ferme tous les présenteurs du flow.
    */
   ...
   protected void closePresenters ()
   {
      ...
      while (!v_presenters.isEmpty())
      {
         ...
         v_pres.close();
         // on ne fait pas un close sur chaque présenteur récupéré initialement car certains présenteurs peuvent en fermer d'autres
