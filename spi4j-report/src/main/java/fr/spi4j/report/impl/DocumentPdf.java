...
public final class DocumentPdf implements Document_Itf
{
   ...
   // les restrictions sur le pdf sur seront débloquées par la saisie de ces informations
   ...
   /**
    * Ajoute les permissions choisies au PDF. Si on ne positionne rien, les valeurs par défaut sont : <br/>
    * - Pas de mot de passe utilisateur <br/>
    * - Pas de mot de passe 'administrateur' <br/>
    * - Impression : autorisée <br/>
    * - Assemblage du document : Non autorisé <br/>
    * - Copie du contenu : Autorisée <br/>
    * - Copie du contenu pour accessibilité: Autorisée <br/>
    * - Extraction de pages : Autorisée <br/>
    * - Commentaires : Autorisés <br/>
    * - Remplissage de champ de formulaires : Autorisé <br/>
    * - Apposition de signature : non autorisée <br/>
    * - Création de modèle de page : non autorisée <br/>
    * Dès que l'on positionne une valeur, le mot de passe administrateur est automatiquement positionné. <br/>
    * S'il est 'null', une valeur aléatoire sera créée. <br/>
    * Si seul le mot de passe administrateur est positionné, ou si les deux mots de passes sont positionnés, les autorisations sont: <br/>
    * - Pas de mot de passe utilisateur <br/>
    * - Mot de passe 'administrateur' <br/>
    * - Impression : non autorisée <br/>
    * - Assemblage du document : Non autorisé <br/>
    * - Copie du contenu : non autorisée <br/>
    * - Copie du contenu pour accessibilité: non Autorisée <br/>
    * - Extraction de pages : non Autorisée <br/>
    * - Commentaires : non Autorisés <br/>
    * - Remplissage de champ de formulaires : non Autorisé <br/>
    * - Apposition de signature : non autorisée <br/>
    * - Création de modèle de page : non autorisée
    * @param p_pdfStamper
    *           Le PDF.
    */
